...
<div class="container">
    ...
    <div class="table-responsive">
        ...
        <div align="center">
            ...
            if($page > 1)
            {
                echo "<a href='pagging.php?page=1'>First</a>";
                echo "<a href='pagging.php?page=".($page - 1)."'><<</a>";
            }
            for($i=$start_loop; $i<=$end_loop; $i++)
            {
                echo "<a href='pagging.php?page=".$i."'>".$i."</a>";
            }
            if($page <= $end_loop)
            {
                echo "<a href='pagging.php?page=".($page + 1)."'>>></a>";
                echo "<a href='pagging.php?page=".$total_pages."'>Last</a>";
            }
