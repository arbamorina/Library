				...
				<nav id="header-nav">
					...
					<ul id="nav-ul" class="menu font-montserrat-reg clearfix">
						...
						<li class="menu-item menu-item-has-children">
							<a href="indexPuntore.php">Home<span class="sub-drop-icon fa fa-angle-down"></span></a>
						</li>
						...
						<li class="menu-item menu-item-has-children">
							<a href="aboutOther.php">About<span class="sub-drop-icon fa fa-angle-down"></span></a>
						</li>

						<!-- Nav item - no drop down -->
						<li class="menu-item menu-item-has-children">
							<a href="portfolioOther.php">Portfolio<span class="sub-drop-icon fa fa-angle-down"></span></a>
						</li>
						...
						<!-- Nav item - no drop down -->
						<li class="menu-item menu-item-has-children">
							<a href="contactOther.php">Contact<span class="sub-drop-icon fa fa-angle-down"></span></a>
						</li>
